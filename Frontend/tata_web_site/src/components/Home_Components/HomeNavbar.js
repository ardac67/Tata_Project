    ...
    return (
        ...
        <MDBContainer fluid>
          ...
          <div className="d-flex justify-content-end">
            <MDBCollapse navbar show={showNav} style={
                {marginRight: "45px"}
            }>
                <MDBNavbarNav>
                ...
                <MDBNavbarItem className="d-flex justify-content-center">
                    <MDBBtn style={{
                        ...
                        backgroundImage:"linear-gradient(90deg, rgb(111, 137, 251) 0%, rgb(97, 109, 245) 33%, rgb(92, 82, 235) 100%)",
                    ...
                    <MDBBtn style={{
                            ...
                            <FontAwesomeIcon icon={faAddressCard} style={{
                                marginRight: "20px",
                                height: "17px"
