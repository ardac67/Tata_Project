          ...
          <MDBRow>
            ...
            <MDBCol md="6">
              ...
              <p className=" text-truncate mb-4 mb-md-0">
                Geryon have been specialized in the small kitchen appliance
                field for over 6 years. We make the production of "GERYON®"
                brand vacuum sealers. All our products are pass FDA, ETL
                approved, and BPA-FREE certifications.
              </p>
              <p className="mb-4 mb-md-0">#lifestyle #cooking #BBQ</p>
            </MDBCol>
            <MDBCol md="6" lg="3" className="border-sm-start-none border-start">
              <div className="d-flex flex-column mt-4">
                <MDBBtn color="primary" size="sm" onClick={() =>redirect("/CampaignDetails")}>
                  Campaign Details
                </MDBBtn>
                <MDBBtn outline color="success" size="sm" className="mt-2" onClick={() =>redirect("/CreateProposal")}>
                  Propose
                </MDBBtn>
              </div>
            </MDBCol>
