            ...
            <MDBContainer className="py-5">
                <MDBRow>
                    ...
                    <MDBCol lg="8">
                        ...
                        <MDBCard className="mb-4">
                            <MDBCardBody>
                            <MDBCardText className=' fw-semibold fs-8'>Why we choose you ?</MDBCardText> <div className="mb-0">
                                <textarea className="form-control" id="additionalInfo" rows={4} placeholder="Enter additional information"></textarea>
                            </div>
