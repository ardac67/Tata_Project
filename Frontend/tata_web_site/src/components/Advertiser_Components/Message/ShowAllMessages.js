...
export default function App () {
  ...
  for (var i = 0; i < collaborations.proposal.length; i++) {
    hashMap[collaborations.proposal[i].user.user_name] =
      collaborations.proposal[i].user.user_image
  }
                    ...
                    <MDBCol>
                      <li className='justify-content-between mb-4'>
                        <div className='d-flex justify-content-end mb-0'>
                          <img
                            src={
                              collaborations.proposal[0].belongToUser.user_image
                                ? `data:image/jpeg;base64,${bufferToBase64(
                                    collaborations.proposal[0].belongToUser
                                      .user_image.data
                                  )}`
                                : defaultImage // Provide a placeholder image
                            }
